...
COMMAND_SPECS = (
    ...
    CommandSpec("/evolution", "inspect DNA evolution evidence", "/evolution [candidates|fitness|datasets|replay|compare|campaigns|explain|promote|rollback|kill|build-dataset|propose|auto-plan]"),
    ...
    CommandSpec("/img", "attach a clipboard or file image, optionally ask about it", "/img [IMAGE] [QUESTION]"),
