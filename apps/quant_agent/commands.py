...
COMMAND_SPECS = (
    ...
    CommandSpec("/evolution", "inspect DNA evolution evidence", "/evolution [candidates|fitness|datasets|replay|compare|campaigns|explain|promote|rollback|kill|build-dataset|propose]"),
