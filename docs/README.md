...
- [类脑 Agent 命令面 MVP 计划](delivery/command-surface-mvp-plan.md)：Brain、Loop、Task、Memory、Catalog、DNA、Evolution 与 Insight 命令入口任务。
- [类脑 Agent 命令面专家审查](reviews/command-surface-mvp-expert-review-2026-08-19.md)：架构、安全、产品和运维评审结论与发布条件。
